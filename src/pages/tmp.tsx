...
function BlockTypePopup({
    ...
    return (
        <motion.div
            ref={popupRef}
            className="fixed bg-cgray-800 rounded-lg p-1 z-50 shadow-xl flex flex-col gap-2"
            style={{
                left: x - 40,
                top: y + 10,
            }}
        ...
        <>
            {isEditMode && (
                <div>
                    ...
                    <div className="absolute -right-7 top-[1rem] flex opacity-0 group-hover:opacity-100 z-10">
                        <button
                            onClick={onDelete}
