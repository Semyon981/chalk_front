...
export interface CheckAccountNameResponse {
    assigned: boolean;
}
...
export interface GetAccountByNameResponse {
    account: Account;
}
...
export interface GetAccountMemberCoursesResponse {
    courses: Course[];
}
export interface GetAccountCoursesResponse {
    courses: Course[];
}
...
export interface GetModulesByCourseIDResponse {
    modules: Module[];
}
...
export interface UpdateModuleOrderResponse {
    success: boolean;
}
export interface GetModuleByIDResponse {
    module: Module;
}
export interface GetLessonsByModuleIDResponse {
    lessons: Lesson[];
}
...
export interface GetBlocksByLessonIDResponse {
    blocks: Block[];
}
...
export interface RemoveInviteRequest {
    id: number;
}
